...
function queryOrder(){
	...
	$("#grid-table").jqGrid('setGridParam',{
        url: url + "?" + data + "&flag=receWattingAndCompleteOrder",
        //postData:jsonData,
        page:1,
        mtype:"post"
...
function querOrderDetial(orderId){
	...
	$.ajax({
      ...
      $("#orderDetialModal input[name='userCourierNum']").val(msg.userCourierNum);
      $("#orderDetialModal select[name='userCourierName']").val(msg.userCourierName);
