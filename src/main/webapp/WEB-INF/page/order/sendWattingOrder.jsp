...
%>
<script src="<%=path%>/pagejs/order/sendWattingOrder.js"></script>
	  ...
	  <div class="panel panel-default">
	    ...
	    <div id="searchDiv" class="panel-collapse collapse">
	      <div class="panel-body">
			  <form id="queryreAndDeOrderForm" class="form-horizontal" role="form">
		     ...
		     <div class="modal-body">
            	<form class="form-horizontal">
					...
					<!-- <div class="form-group">
						...
						<div class="col-xs-12 col-sm-4">
							<div class="clearfix">
								<input type="text"  name="courierPhone" class="col-xs-12 col-sm-12" />
							</div>
						</div>
					</div> -->
				</form>				     
